...
const Prices = () => {
	return (
		<div
			id="prices"
			className=" bg-[#0784b5] flex flex-col items-center px-3 text-lg py-12"
		>
			<h1 className="text-4xl font-bold mb-8 text-white">💸 Klímatisztítás árlista</h1>
				...
				<table className="w-full table-fixed border-collapse rounded-lg overflow-hidden shadow-lg bg-white text-gray-800">
					...
					<tbody>
						<tr className="even:bg-[#eaf6fb] odd:bg-white">
							...
							<td className="px-4 py-4 text-center">19.990 Ft</td>
							<td className="px-4 py-4 text-center">19.990 Ft/db</td>
						</tr>
						<tr className="even:bg-[#eaf6fb] odd:bg-white">
						...
						<tr className="even:bg-[#eaf6fb] odd:bg-white">
							...
							<td className="px-4 py-4 text-center">14.990 Ft/db</td>
						</tr>
					</tbody>
				</table>
			</div>
